...
class PermissionRoleTableSeeder extends Seeder
{
    ...
    {
        // role_create ,role_edit,role_show, role_delete role_access profile_access profile_edit user_change_password address_access address_create address_edit address_delete staff_access staff_create staff_edit staff_show staff_delete customer_access customer_create customer_edit customer_show customer_delete master_access category_access category_create category_edit category_show category_delete product_access product_create product_edit product_show product_delete  device_access device_create device_edit device_show device_delete invoice_access invoice_create invoice_edit invoice_show invoice_print invoice_share invoice_download invoice_delete order_product_access order_product_create order_product_copy order_product_edit order_product_show order_product_delete report_access get_sales_report_access setting_access  setting_edit
