...
class PermissionRoleTableSeeder extends Seeder
{
    ...
    {
        // role_create ,role_edit,role_show, role_delete role_access profile_access profile_edit user_change_password address_access address_create address_edit address_delete staff_access staff_create staff_edit staff_show staff_delete customer_access customer_create customer_edit customer_show customer_delete master_access category_access category_create category_edit category_show category_delete product_access product_create product_edit product_show product_delete  device_access device_create device_edit device_show device_delete invoice_access invoice_create invoice_edit invoice_show invoice_print invoice_share invoice_download invoice_delete invoice_restore order_product_access order_product_create order_product_copy order_product_edit order_product_show order_product_delete report_access get_sales_report_access setting_access  setting_edit product_merge product_print product_export category_print category_export address_print address_export report_category_access phone_book_access phone_book_print phone_book_export invoice_recycle_access customer_print customer_export staff_print staff_export invoice_export invoice_filter dashboard_widget_access invoice_date_filter setting_invoice_allow_days report_customer_access , report_customer_approve ,report_customer_edit ,report_product_access,report_product_approve,report_product_edit

        $roles = Role::all();
        $superadminpermissionid= Permission::all();

        $adminpermissionid= Permission::whereIn('name',['profile_access', 'profile_edit', 'user_change_password' ,'invoice_access','invoice_filter','invoice_create','invoice_delete','invoice_edit','invoice_show','invoice_print','invoice_export', 'invoice_share' ,'invoice_download', 'order_product_access', 'order_product_create', 'order_product_copy' ,'order_product_edit', 'order_product_delete' ,'phone_book_access','phone_book_print','phone_book_export','customer_edit','customer_delete','customer_create','customer_print','customer_export'])->pluck('id')->toArray();

        $accountantpermissionid= Permission::whereIn('name',['profile_access', 'profile_edit', 'user_change_password' ,
        'staff_access','staff_create','staff_edit','staff_show','staff_delete','staff_print','staff_export','invoice_access','invoice_filter','invoice_create','invoice_delete','invoice_edit','invoice_show','invoice_print','invoice_export','invoice_share' ,'invoice_download','invoice_restore','invoice_recycle_access', 'order_product_access', 'order_product_create', 'order_product_copy' ,'order_product_edit', 'order_product_delete' ,'customer_access','customer_edit','customer_delete','customer_create','customer_print','customer_export','address_access','address_edit','address_delete','address_print','address_export','master_access','category_access','category_create','category_edit','category_show','category_delete','category_print','category_export','product_access','product_create','product_edit','product_show','product_delete','product_merge','product_print','product_export','device_access','device_create','device_edit','device_show','device_delete','setting_access','setting_edit','phone_book_access','phone_book_print','phone_book_export'])->pluck('id')->toArray();
