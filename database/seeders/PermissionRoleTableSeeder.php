...
class PermissionRoleTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        'staff_access','staff_create','staff_edit','staff_delete','staff_print','staff_export','invoice_access','invoice_filter','invoice_create','invoice_delete','invoice_edit','invoice_show','invoice_print','invoice_export','invoice_share' ,'invoice_download','invoice_restore','invoice_recycle_access', 'order_product_access', 'order_product_create', 'order_product_copy' ,'order_product_delete' ,'customer_access','customer_edit','customer_delete','customer_create','customer_print','customer_export','address_access','address_edit','address_delete','address_print','address_export','master_access','category_access','category_create','category_edit','category_delete','category_print','category_export','product_access','product_create','product_edit','product_delete','product_merge','product_print','product_export','device_access','device_create','device_edit','device_delete','setting_access','setting_edit','phone_book_access','phone_book_print','phone_book_export'])->pluck('id')->toArray();
