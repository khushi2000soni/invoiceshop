...
@section('content')
    ...
    <main class="main" style="width:100%; max-width: 100%; margin:10px auto 0; padding: 40px 0; padding-top: 20px;">
        <table cellpadding="0" cellspacing="0" width="100%" style="color: #000; font-size: 16px;">
            <thead>
                <tr>
                    ...
                    <th style="padding: 10px;border: 1px solid #000;border-right: none;" align="center">@lang('quickadmin.customers.fields.phone2')</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 10px;border: 1px solid #000;border-right: none;border-top: none;" align="center">{{ $customer->phone}}  </td>
                    <td style="padding: 10px;border: 1px solid #000;border-right: none;border-top: none;" align="center">{{ $customer->phone2  ?? ''}}</td>
