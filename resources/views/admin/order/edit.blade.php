  ...
  <script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#editProductBtn', function (e) {
            ...
            $(".is-invalid").removeClass("is-invalid");
            var productToEdit = order.products[rowIndex];
            var productname = productToEdit.product_name;
            var order_product_id = productToEdit.order_product_id;
            ...
            for (const elementId in updatedProduct) {
                if (elementId === 'order_product_id') {
                    continue; // Skip the order_product_id field
                }
        ...
        function calculateGrandTotal() {
            ...
            var thailaPrice = parseFloat(order.thailaPrice) || 0;
            var isRoundOff = order.is_round_off;
            var roundedSubtotal = isRoundOff ? Math.round(subTotal) : 0;
            ...
            console.log('isRoundOff',isRoundOff);
