        ...
        <div class="card author-box">
          ...
          <div class="card-body">
            ...
            <div class="text-center">
              ...
              <a href="#" class="btn btn-social-icon mr-1 btn-facebook" data-toggle="tooltip" title=""
                data-original-title="501 Sales">
                <i class="fab fa-facebook-f"></i>
              </a>
              <a href="#" class="btn btn-social-icon mr-1 btn-twitter" data-toggle="tooltip" title=""
                data-original-title="267 Sales">
                <i class="fab fa-twitter"></i>
              </a>
              <a href="#" class="btn btn-social-icon mr-1 btn-instagram" data-toggle="tooltip" title=""
                data-original-title="308 Sales">
