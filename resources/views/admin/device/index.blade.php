            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                  ...
                  @can('device_create')
                  <button type="button" class="addnew-btn addRecordBtn" data-toggle="modal" data-target="#centerModal" data-href="{{ route('device.create')}}"><x-svg-icon icon="add-device" /></button>
                  @endcan
                </div>
                <div class="card-body">
